...
public class Data extends BaseBusEntity {
    ...
    @GenericGenerator(name = "serialnumber", strategy = "serialnumber", parameters = {@org.hibernate.annotations.Parameter(name = "expression", value = "'A' + #DateUtil.format('yyyyMMdd') + #StringUtil.addZeroLeft(#SequenceInfo.nextValue('TEST-SN'), 5)")})
    private String sn;
    /**
     * 文章标题
     */
