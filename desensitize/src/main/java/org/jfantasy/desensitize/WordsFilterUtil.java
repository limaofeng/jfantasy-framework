...
public class WordsFilterUtil {
  ...
  public static void main(String[] args) {
    ...
    // filterTextWithPunctation("江阴毛纺厂和大江阴毛纺厂生产的毛巾都来自姗姗来迟地毯厂，但是，来*迟!地(毯)生产的毛巾不错",
    // '*');
    ...
    // WordsFilterUtil.addWords(WordsType.SENSITIVE, new
    // ByteArrayInputStream("阴毛=1".getBytes()));
