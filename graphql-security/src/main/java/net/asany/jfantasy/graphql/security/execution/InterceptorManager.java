...
public class InterceptorManager {
  ...
  public void executeBefore(ExecutionContext executionContext, ExecutionStrategyParameters parameters) {
    interceptors.stream()
  ...
  public ExecutionResult executeAfter(ExecutionContext executionContext, ExecutionStrategyParameters parameters, ExecutionResult result) {
