...
@Component
public class PublishOrderPayEventByMNS implements ApplicationListener<OrderPayEvent> {
    ...
    public void onApplicationEvent(OrderPayEvent event) {
        ...
        eventEmitter.fireEvent("order.paid",order.getId(),String.format("订单[%s]支付",order.getId()), JSON.serialize(order, "payments", "refunds", "payment_config"));
    }
