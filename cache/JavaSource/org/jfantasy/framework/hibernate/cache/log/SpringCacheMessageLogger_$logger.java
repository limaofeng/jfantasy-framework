...
public class SpringCacheMessageLogger_$logger extends DelegatingBasicLogger implements Serializable, SpringCacheMessageLogger, CoreMessageLogger, BasicLogger {
    ...
    private static final String FQCN = SpringCacheMessageLogger_$logger.class.getName();
    ...
    private static final String providerClassDeprecated = "HHH000208: %s has been deprecated in favor of %s; that provider will be used instead.";
    ...
    private static final String unableToClosePooledConnection = "HHH000293: Problem closing pooled connection";
    ...
    private static final String unableToExecuteBatch = "HHH000315: Exception executing batch [%s]";
    private static final String javassistEnhancementFailed = "HHH000142: Javassist Enhancement failed: %s";
    ...
    private static final String jdbcUrlNotSpecified = "HHH000152: JDBC URL was not specified by property %s";
    ...
    private static final String connectionProperties = "HHH000046: Connection properties: %s";
    ...
    private static final String attemptToRestartAlreadyStartedEhCacheProvider = "HHH020001: Attempt to restart an already started EhCacheRegionFactory.  Use sessionFactory.close() between repeated calls to buildSessionFactory. Using previously created EhCacheRegionFactory. If this behaviour is required, consider using org.hibernate.cache.ehcache.SingletonEhCacheRegionFactory.";
    ...
    private static final java.lang.String logUnexpectedSessionInCollectionNotConnected = "HHH000470: An unexpected session is defined for a collection, but the collection is not connected to that session. A persistent collection may only be associated with one session at a time. Overwriting session. %s";
    ...
    private static final String usingDriver = "HHH000401: using driver [%s] at URL [%s]";
    ...
    private static final String autoFlushWillNotWork = "HHH000008: JTASessionContext being used with JDBCTransactionFactory; auto-flush will not operate correctly with getCurrentSession()";
    ...
    private static final String unableToRetrieveCache = "HHH000361: Unable to retreive cache from JNDI [%s]: %s";
    ...
    private static final String jdbcIsolationLevel = "HHH000149: JDBC isolation level: %s";
    ...
    private static final java.lang.String logCannotUnsetUnexpectedSessionInCollection = "HHH000471: Cannot unset session in a collection because an unexpected session is defined. A persistent collection may only be associated with one session at a time. %s";
    ...
    private static final String unknownSqlServerVersion = "HHH000385: Unknown Microsoft SQL Server major version [%s] using SQL Server 2000 dialect";
    ...
    private static final String jdbcDriverNotSpecified = "HHH000148: No JDBC Driver class was specified by property %s";
    ...
    private static final String unableToFindEhCacheConfiguration = "HHH020003: Could not find a specific ehcache configuration for cache named [%s]; using defaults.";
    ...
    private static final String failed = "HHH000099: an assertion failure occured (this may indicate a bug in Hibernate, but is more likely due to unsafe use of the session): %s";
    ...
    private static final String invalidPrimaryKeyJoinColumnAnnotation = "HHH000137: Root entity should not hold an PrimaryKeyJoinColum(s), will be ignored";
    ...
    private static final String usingHibernateBuiltInConnectionPool = "HHH000402: Using Hibernate built-in connection pool (not for production use!)";
    private static final String unableToCompleteSchemaValidation = "HHH000300: Could not complete schema validation";
    private static final String cleaningUpConnectionPool = "HHH000030: Cleaning up connection pool [%s]";
    ...
    private static final String unknownBytecodeProvider = "HHH000382: unrecognized bytecode provider [%s], using javassist by default";
    ...
    public SpringCacheMessageLogger_$logger(final Logger log) {
        super(log);
    }
    ...
    public final void attemptToRestartAlreadyStartedEhCacheProvider() {
        super.log.logf(FQCN, (org.jboss.logging.Logger.Level.WARN), null, attemptToRestartAlreadyStartedEhCacheProvider$str());
    }

    protected String attemptToRestartAlreadyStartedEhCacheProvider$str() {
        return attemptToRestartAlreadyStartedEhCacheProvider;
    }
    ...
    public final void unableToFindEhCacheConfiguration(final String name) {
        super.log.logf(FQCN, (org.jboss.logging.Logger.Level.WARN), null, unableToFindEhCacheConfiguration$str(), name);
    }

    protected String unableToFindEhCacheConfiguration$str() {
        return unableToFindEhCacheConfiguration;
    }
    ...
    @Override
    public void attemptToRestartAlreadyStartedSpringCacheProvider() {
    }
    ...
    @Override
    public void unableToFindSpringCacheConfiguration(String name) {
    }
    ...
    @Override
    public void stalePersistenceContextInEntityEntry(String msg) {
