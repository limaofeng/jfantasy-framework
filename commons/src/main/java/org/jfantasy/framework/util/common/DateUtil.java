...
public class DateUtil extends DateUtils {
  ...
  public static String intervalFormat(
    ...
    long day = Calendar.DATE == field ? field : 0,
        hour = (field == Calendar.HOUR_OF_DAY || field == Calendar.HOUR) ? between : 0,
        minute = (field == Calendar.MINUTE) ? between : 0,
        second = (field == Calendar.SECOND) ? between : 0;
    switch (field) {
      ...
      default: // Calendar.DATE or Calendar.MONTH or Calendar.YEAR
        throw new UnsupportedException("不支持的时间转换格式:" + field);
    }
    final String days = String.valueOf(day),
