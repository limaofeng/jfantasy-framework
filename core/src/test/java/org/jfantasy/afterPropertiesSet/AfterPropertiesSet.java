...
// + "-default", "默认文件管理器", "/home/" + webSite.getKey(), "默认文件管理器,请勿删除"));
// }
...
// FileManagerConfig.newInstance(webSite.getKey() +
// "-upload", "默认文件上传管理器", FileManagerConfig.newInstance(webSite.getKey() +
// "-default"),
// "默认文件上传管理器"));
// }
...
// ""));
// settings.add(Setting.newInstance(webSite, "所有权", "copyright", "2014版权所有 All
// Right
// Reserved", ""));
// settings.add(Setting.newInstance(webSite, "欢迎页面标题", "wel_tle",
// "欢迎使昊略信息技术有限公司-网站后台管理系统", ""));
// settings.add(Setting.newInstance(webSite, "欢迎页面描述", "wel_des",
// "昊略-网站后台管理系统***************************", ""));
// settings.add(Setting.newInstance(webSite, "版本", "wel_ver", "V1.0.1", "版本号"));
// settings.add(Setting.newInstance(webSite, "所有权", "wel_copyr", "@copyright
// 2014",
// "所有权"));
// settings.add(Setting.newInstance(webSite, "网站图标", "icon",
// "/images/rex04.ico",
// "标题上的icon图片"));
// settings.add(Setting.newInstance(webSite, "应用地址", "serverUrl",
// "http://localhost:8080", ""));
//
