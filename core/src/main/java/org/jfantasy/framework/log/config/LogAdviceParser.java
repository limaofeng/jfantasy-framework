...
public class LogAdviceParser extends AbstractSingleBeanDefinitionParser {
  ...
  private static class Props {
    ...
    <T extends CacheOperation, B extends CacheOperation.Builder> T merge(
        Element element, ReaderContext readerCtx, B op, Class<T> clazz) {
  ...
  protected void doParse(
    ...
    if (!cacheDefs.isEmpty()) {
      ...
      builder.addPropertyValue(
          "cacheOperationSources", new RootBeanDefinition(AnnotationCacheOperationSource.class));
    }
  }
