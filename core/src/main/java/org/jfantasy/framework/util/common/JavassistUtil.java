...
public class JavassistUtil {
  ...
  public static String[] getParamNames(String classname, Method method)
    ...
    CtMethod cm =
        getCtClass(classname).getDeclaredMethod(method.getName(), getDefault().get(paramTypeNames));
  ...
  public static String getParameterName(Class<?> clazz, Method method, int index)
      throws NotFoundException, MissingLVException {
