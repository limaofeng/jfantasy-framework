...
public class LimitPageRequest implements Pageable, Serializable {
     ...
     * @since 2.0
     */
    public static LimitPageRequest of(int page, int size, Sort.Direction direction, String... properties) {
    ...
    public LimitPageRequest previous() {
        return getPageNumber() == 0 ? this : new LimitPageRequest(getPageNumber() - 1, getPageSize(), getSort());
    }
