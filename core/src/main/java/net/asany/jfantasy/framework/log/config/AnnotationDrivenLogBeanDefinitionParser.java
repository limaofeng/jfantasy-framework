...
import net.asany.jfantasy.framework.log.annotation.AnnotationLogOperationSource;
import net.asany.jfantasy.framework.log.interceptor.BeanFactoryLogOperationSourceAdvisor;
...
public class AnnotationDrivenLogBeanDefinitionParser implements BeanDefinitionParser {
  ...
  public static final String LOG_ADVISOR_BEAN_NAME =
      "org.springframework.log.config.internalLogAdvisor";
  public static final String LOG_ASPECT_BEAN_NAME =
  ...
  private static void parseCacheManagerProperty(Element element, BeanDefinition def) {
    def.getPropertyValues()
        .add(
            "logManager",
            new RuntimeBeanReference(LogNamespaceHandler.extractCacheManager(element)));
  }
  ...
  private static class AopAutoProxyConfigurer {
    ...
    public static void configureAutoProxyCreator(Element element, ParserContext parserContext) {
      ...
      if (!parserContext.getRegistry().containsBeanDefinition(LOG_ADVISOR_BEAN_NAME)) {
        ...
        interceptorDef
            .getPropertyValues()
            .add("logOperationSources", new RuntimeBeanReference(sourceName));
        ...
        RootBeanDefinition advisorDef =
            new RootBeanDefinition(BeanFactoryLogOperationSourceAdvisor.class);
        advisorDef.setSource(eleSource);
        advisorDef.setRole(BeanDefinition.ROLE_INFRASTRUCTURE);
        advisorDef.getPropertyValues().add("adviceBeanName", interceptorName);
        advisorDef
            .getPropertyValues()
            .add("logOperationSource", new RuntimeBeanReference(sourceName));
        ...
        compositeDef.addNestedComponent(
            new BeanComponentDefinition(advisorDef, LOG_ADVISOR_BEAN_NAME));
