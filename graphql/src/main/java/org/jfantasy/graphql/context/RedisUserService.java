...
@ConditionalOnMissingBean(GraphQLUserDetailsService.class)
public class RedisUserService implements GraphQLUserDetailsService {

    @Autowired
    private StringRedisTemplate redisTemplate;

    @Override
    public LoginUser loadUserByToken(String token) throws UsernameNotFoundException {
