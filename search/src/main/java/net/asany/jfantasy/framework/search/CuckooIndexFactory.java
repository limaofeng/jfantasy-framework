...
import net.asany.jfantasy.framework.search.config.IndexedScanner;
import net.asany.jfantasy.framework.search.dao.CuckooDao;
import net.asany.jfantasy.framework.search.elastic.ElasticCuckooIndex;
import net.asany.jfantasy.framework.search.elastic.ElasticsearchConnection;
