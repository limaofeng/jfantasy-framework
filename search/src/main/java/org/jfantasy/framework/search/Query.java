...
public class Query {
  ...
  //    QueryParser parser =
  //        new QueryParser(
  //            BuguIndex.getInstance().getVersion(), field, BuguIndex.getInstance().getAnalyzer());
  ...
  //            BuguIndex.getInstance().getVersion(), fields,
  // BuguIndex.getInstance().getAnalyzer());
  //    parser.setDefaultOperator(op);
  //    return parse(parser, value);
  //  }
  //
  ...
  //              BuguIndex.getInstance().getVersion(),
  //              value,
  //              fields,
  //              occurs,
  //              BuguIndex.getInstance().getAnalyzer());
  ...
  //              BuguIndex.getInstance().getAnalyzer());
  //    } catch (ParseException ex) {
  //      LOGGER.error("MultiFieldQueryParser can not parse the values " + Arrays.toString(values),
  // ex);
  //    }
  //    return query;
  //  }
  ...
  //    Assert.isTrue(queries.length != 0, "param queries length must be greater than 1 ");
  //    Assert.isTrue(queries.length == occurs.length, "length of queries and occurs must be
  // equal");
  //    BooleanQuery query = new BooleanQuery();
