...
public enum DateFormat {
  ...
  basic_week_date_time(
      "YYYY'W'wwe'T'HHmmss.SSSX"), // here Elasticsearch uses a different zone format
  ...
  date_time_no_millis(
      "uuuu-MM-dd'T'HH:mm:ssVV"), // here Elasticsearch uses the zone-id in it's implementation
